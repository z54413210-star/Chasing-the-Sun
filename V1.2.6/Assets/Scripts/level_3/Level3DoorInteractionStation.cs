...
public class Level3DoorInteractionStation : MonoBehaviour
{
    ...
    private static readonly Dictionary<PlayerController2D, MovementLockState> MovementLocks =
        new Dictionary<PlayerController2D, MovementLockState>();
    ...
    private PlayerController2D _interactingPlayer;
    private PlayerController2D _lockedPlayer;
    ...
    private void AcquireInteractionLock(PlayerController2D player)
    {
        if (player == null)
        {
            return;
    ...
    private static void AcquireMovementLock(PlayerController2D player)
    {
        if (player == null)
        {
            return;
    ...
    private static void ReleaseMovementLock(PlayerController2D player)
    {
