...
public class LevelTransitionSequence : MonoBehaviour
{
    ...
    [SerializeField] private float creditsFontSize = 30f;
    [SerializeField] private float creditsLineSpacing = 16f;
    [SerializeField] private float creditsTopOffset = 270f;
    ...
    private void BuildUi()
    {
        ...
        credRt.anchorMin = new Vector2(0.08f, 0f);
        credRt.anchorMax = new Vector2(0.92f, 1f);
        credRt.offsetMin = Vector2.zero;
        credRt.offsetMax = new Vector2(0f, -creditsTopOffset);
        _creditsRootGroup = credRoot.AddComponent<CanvasGroup>();
        _creditsRootGroup.alpha = 0f;
        var credVlg = credRoot.AddComponent<VerticalLayoutGroup>();
        credVlg.spacing = creditsLineSpacing;
        credVlg.childAlignment = TextAnchor.UpperCenter;
