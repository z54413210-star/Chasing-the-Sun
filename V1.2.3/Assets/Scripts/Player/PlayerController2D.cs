...
public class PlayerController2D : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        if (GetComponent<PlayerLadderTraversalAssist>() == null)
        {
            gameObject.AddComponent<PlayerLadderTraversalAssist>();
        }
    ...
    {
        var ladderAssist = GetComponent<PlayerLadderTraversalAssist>();
